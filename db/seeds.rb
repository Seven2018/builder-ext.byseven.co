...
Content.create(title: "Etre à l'aise à l'oral", theme_id: 1, description: "https://drive.google.com/uc?id=1HYUlpZs-eJ3DYRk0lp3dQECOUX8r2Mnr")
Content.create(title: 'Créer un climat de confiance', theme_id: 1, description: "https://drive.google.com/uc?id=1xjKclS2gwLBQTJKTCT4mI3mAo1aXrLif")
Content.create(title: 'Faire preuve de courage managérial', theme_id: 1, description: "https://drive.google.com/uc?id=1sK2iBKw4PYnS6PqzoRS8XxilzJb-DkRc")
Content.create(title: 'Concevoir une trame de formation SEVEN', theme_id: 1, description: "https://drive.google.com/uc?id=19AQALCj_AytizMahPkVoCTNbD8p85bNh")
Content.create(title: 'Etre inspiré et inspirant', theme_id: 1, description: "https://drive.google.com/uc?id=1vzn0u_fMZDplvNCyGUFPZ5dG3FKnFOtA")
Content.create(title: 'Savoir écouter', theme_id: 2, description: "https://drive.google.com/uc?id=14oxdzxFLL9LHLEY8IRSEcB-vhR85uicJ")
Content.create(title: 'Manager selon la situation', theme_id: 2, description: "https://drive.google.com/uc?id=1bK_jO3Q7UOn3ZIlwu6J-wFqk-SOC_xWj")
Content.create(title: 'Bien déléguer', theme_id: 2, description: "https://drive.google.com/uc?id=1zd8yRzlpaWnSDDNKC1NCnJH6hfZxoykY")
Content.create(title: 'Connaître et partager ses leviers de motivations', theme_id: 2, description: "https://drive.google.com/uc?id=1jqmPxXHBINE_GkGp0LTCkpuRNTIU_3EA")
Content.create(title: 'Construire un collectif', theme_id: 2, description: "https://drive.google.com/uc?id=1JFj9bRtpYlTbnRQnuLfd088jDFlCvb8Z")
Content.create(title: 'Faire un feedback constructif', theme_id: 2, description: "https://drive.google.com/uc?id=1bl8ZRdFilp4yfODiyEGXcWYxvR4jlD7v")
Content.create(title: 'Gérer les conflits à chaud', theme_id: 2, description: "https://drive.google.com/uc?id=12HCQ6v7-4WaVqYzOpIn0FRKTmmZRrBZy")
Content.create(title: 'Gérer les conflits à froid', theme_id: 2, description: "https://drive.google.com/uc?id=1nloSwtOIHoff_2ywQsZEu0ENuwHixalc")
Content.create(title: 'Travailler ensemble', theme_id: 3, description: "https://drive.google.com/uc?id=1ltjKfJABAyfDilrqwrhXagXOKfCEXn7k")
Content.create(title: 'Communiquer efficacement', theme_id: 3, description: "https://drive.google.com/uc?id=1kLR934b5gwun56KXuwo1VWm0GAgiml_Q")
Content.create(title: 'Construire son Personal Branding', theme_id: 3, description: "https://drive.google.com/uc?id=1QoZB90bY08rddJILjndE0WhRnIyL6FcK")
Content.create(title: 'Négocier : les grands principes', theme_id: 4, description: "https://drive.google.com/uc?id=19ObXUNqKRxevPXJe0dVbS0YOQgIWncOi")
Content.create(title: 'Préparer une négociation', theme_id: 4, description: "https://drive.google.com/uc?id=1TxTvUj5ODPmt-R1FFIejHjKRRujz6Ahe")
Content.create(title: 'Anticiper les positions dans la négociation', theme_id: 4, description: "https://drive.google.com/uc?id=1RWStAA53R37iorJwzPKQqpxyXCcljjHd")
Content.create(title: 'Etre créatif en négociation', theme_id: 4, description: "https://drive.google.com/uc?id=14JD4Iwci8En-mS0_WC7ebdlhnDe4Qzk_")
Content.create(title: 'Etre "efficient" avec les lois du temps', theme_id: 5, description: "https://drive.google.com/uc?id=158jSGf745yFrUqnDG65lP79Yo2wNopL8")
Content.create(title: "Etre efficace avec la matrice d'Eisenhower", theme_id: 5, description: "https://drive.google.com/uc?id=1WMK3dcYz0TOzvh7rhhZ0v4magbrFQIjH")
Content.create(title: 'Etre influent', theme_id: 6, description: "https://drive.google.com/open?id=1rEgICKmmDOY50EtQ8FL8XHwAJgUhTcpg")
Content.create(title: 'Comprendre et anticiper les dynamiques sociales', theme_id: 6, description: "https://drive.google.com/uc?id=17-6_vLV-FrSxM89Z0571ldlFCjgu7Dwy")
Content.create(title: 'Relever le Marshmallow Challenge', theme_id: 7, description: "https://drive.google.com/uc?id=1npVabsqOBlv6pKqvQBEt9j-2_obiJ-SW")
