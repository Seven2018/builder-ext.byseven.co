class TrainingsController < ApplicationController
  ...
  def index
    ...
    if ['super admin', 'admin', 'project manager'].include?(current_user.access_level)
      ...
      @trainings = (trainings.select{|x| x.next_session.present?}.sort_by{|y| y.next_session} + trainings.select{|z| !z.next_session.present? && z.end_time.present?}.sort_by{|a| a.end_time}.reverse)[(n-1)*30..n*30]
    # Index for Sevener Users, with limited visibility
    else
