...
class InvoiceItemsController < ApplicationController
  ...
  def index
    ...
    @invoice_items = @invoice_items_total = InvoiceItem.where(created_at: params[:export][:start_date]..params[:export][:end_date], type: params[:type]).order(:uuid) if (params[:export].present? && params[:type])
